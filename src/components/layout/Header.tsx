...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-dark-950/95 backdrop-blur-sm border-b border-dark-800">
      ...
      {/* Mobile top bar - phone + Hikvision + review */}
      <div className="md:hidden bg-primary-600 py-2">
        <Container>
          <div className="flex items-center justify-between gap-3">
            ...
            <Link
              href="/partner-hikvision/"
              className="flex items-center gap-1.5 px-2 py-0.5 bg-white/10 border border-white/20 rounded"
            >
              <Image
                src="/images/partners/hikvision-logo.png"
                alt="Hikvision"
                width={60}
                height={12}
                className="h-3 w-auto brightness-200"
                unoptimized
              />
              <span className="text-[10px] font-semibold text-white/90 leading-none">Partner</span>
            </Link>
